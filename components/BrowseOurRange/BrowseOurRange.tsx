      ...
      <div className="lg:rounded-2xl rounded-none px-3 xl:px-0">
        <div className="grid lg:grid-cols-2 lg:rounded-2xl rounded-b-2xl  shadow-2xl">
          <Image
            ...
            height={1000}
          />
          <div className="bg-emerald-500/20 text-center lg:rounded-tr-2xl lg:rounded-br-2xl lg:rounded-b-none rounded-b-2xl flex flex-col justify-center items-center px-10 py-10 space-y-10">
            ...
            <button className="bg-emerald-500 hover:shadow-lg border-b-2 border-black/30 hover:translate-y-0.5 ease-in-out duration-100 px-6 py-3 rounded-full text-white text-sm">
              Browse Our Range
            </button>
          </div>
        </div>
